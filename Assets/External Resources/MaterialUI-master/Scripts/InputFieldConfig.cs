...
namespace MaterialUI
{
	...
	{	
        ...
        [SerializeField] private Image panelLayer;
    ...
    /*   void SetCarretVisible(int pos)
        {
            ...
            inputField.GetType().GetField("m_AllowInput", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).SetValue(inputField, true);
            inputField.GetType().InvokeMember("SetCaretVisible", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.InvokeMethod | System.Reflection.BindingFlags.Instance, null, inputField, null);
        ...
        void Update ()
		{
			...
			if (selected)
			{
                ...
                //SetCarretVisible(inputField.caretPosition);
            }
            ...
            if (!GameManager.Instance.FinaleRound)
            {
                if (!isAnswerSubmitted & (Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.KeypadEnter)))
                {
                    ...
                    GameManager.Instance.SubmitCashAnswer(displayText.text.ToString());
            ...
            else
            {
                ...
                {
                    isAnswerSubmitted = true;
                    GameManager.Instance.SubmitFinaleCashAnswer(displayText.text.ToString());
                    StartCoroutine(ValidateAnswer());
                   // StartCoroutine(ResetBackgroundPanelLayerCo());
                }
            }

          //  Debug.Log("current selected =" + _eventSystem.currentSelectedGameObject);
        }
        ...
        IEnumerator ValidateAnswer()
        {
            ...
            if (GameManager.Instance.FinaleRound)
                panelLayer.color = new Color(0.7f, 0.7f, 0.7f, 1);
            yield return new WaitForSeconds(0.9f);
            panelLayer.color = Color.white;
            isAnswerSubmitted = false;
            //OnDeselect();
     ...
     /*   public void OnSubmit(BaseEventData data)
        {
            Debug.Log("réponse soumise");
            _eventSystem.SetSelectedGameObject(null, data);
        }*/
